...
<body id="index">
    ...
    <div class="maintext" id="maintext">
        <p>En este proyecto, desarrollaremos un portal destinado a organizaciones que requieren procesos de votación,
            especialmente, aunque no exclusivamente, dirigido a partidos políticos, ayuntamientos, instituciones,
            claustros, entre otros.</p>
        ...
        <p>Los usuarios anónimos podrán participar en votaciones mediante un enlace de votación que recibirán por correo
            electrónico. Si deciden registrarse más adelante con esa dirección de correo electrónico, podrán acceder a
            sus votaciones anteriores.</p>
    </div>
    </div>
    <?php
